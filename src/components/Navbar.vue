<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-light sticky-top d-md-none p-0">
        <button class="navbar-toggler m-2 mr-0" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo03" aria-controls="navbarTogglerDemo03" aria-expanded="false" aria-label="Toggle navigation">
